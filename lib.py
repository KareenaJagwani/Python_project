...
class Library:
    ...
    def __init__(self,root):
        ...
        self.lblTitle =Label(TitleFrame,width=39,font=('Times New Roman',40,'bold'),text="\tLibrary Management System\t",bg="gold",fg='darkblue',padx=12)
        self.lblTitle.grid()
        ...
        DataFrameLEFT =LabelFrame(DataFrame,bd=10,width=900,height=300,padx=20,relief=RIDGE,font=('Times New Roman',12,'bold'),text="Library Membership Info:",fg="darkblue")
        DataFrameLEFT.pack(side=LEFT)

        DataFrameRIGHT =LabelFrame(DataFrame,bd=10,width=450,height=300,padx=20,relief=RIDGE,font=('Times New Roman',12,'bold'),text="BookDetails",fg="darkblue")
        ...
        #=======================================Button=========================================================================
        self.btnDisplayData=Button(ButtonFrame,text="DISPLAYDATA",fg="darkblue",bg="gold",font=('Times New Roman',12,'bold'),width=30,bd=4,command=DisplayData)
        self.btnDisplayData.grid(row=0,column=0)

        self.btnDelete=Button(ButtonFrame,text="DELETE",fg="darkblue",bg="gold",font=('Times New Roman',12,'bold'),width=30,bd=4,command=Delete)
        self.btnDelete.grid(row=0,column=1)

        self.btnReset=Button(ButtonFrame,text="RESET",fg="darkblue",bg="gold",font=('Times New Roman',12,'bold'),width=30,bd=4,command=Reset)
        self.btnReset.grid(row=0,column=2)

        self.btnExit=Button(ButtonFrame,text="EXIT",fg="darkblue",bg="gold",font=('Times New Roman',12,'bold'),width=30,bd=4,command=Exit)
